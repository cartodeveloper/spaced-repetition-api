...
const UserService = {
  ...
  populateUserWords(db, user_id) {
    return db.transaction(async (trx) => {
      ...
      const languageWords = [
        ["esternocleidomastoideo", "sternocleidomastoid", 2],
        ["otorrinolaringologo", "otolaryngologist", 3],
        ["impermeabilizante", "waterproof", 4],
        ["sonrojado", "blushing", 5],
        ["raro", "weird", 6],
        ["roedor", "rodent", 7],
        ["prorrogar", "extend", 8],
        ["zarrapastroso", "scruffy", null],
      ];
