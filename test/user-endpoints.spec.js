    ...
    describe(`Given a valid user`, () => {
      ...
      it(`inserts 1 language with words for the new user`, () => {
        ...
        const expectedList = {
          ...
          words: [
            {
              original: "esternocleidomastoideo",
              translation: "sternocleidomastoid",
            },
            {
              original: "otorrinolaringologo",
              translation: "otolaryngologist",
            },
            { original: "impermeabilizante", translation: "waterproof" },
            { original: "sonrojado", translation: "blushing" },
            { original: "raro", translation: "weird" },
            { original: "roedor", translation: "rodent" },
            { original: "prorrogar", translation: "extend" },
            { original: "zarrapastroso", translation: "scruffy" },
          ],
        };
        return supertest(app)
          .post("/api/user")
